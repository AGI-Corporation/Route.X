...
export class ModifyProjectMembers1717961669938 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        for (const projectMember of projectMembers) {
            ...
            await queryRunner.query('INSERT INTO "project_member" ("id", "created", "updated", "projectId", "platformId", "userId", "role") VALUES ($1, $2, $3, $4, $5, $6, $7)', [
                projectMember.id,
                dayjs(projectMember.created).toISOString(),
                dayjs(projectMember.updated).toISOString(),
                projectMember.projectId,
                projectMember.platformId,
                user[0].id,
                projectMember.role,
            ])
        }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        for (const projectMember of projectMembers) {
            ...
            if (user.length > 0) {
                await queryRunner.query('INSERT INTO "project_member" ("id", "created", "updated", "projectId", "platformId", "email", "status", "role") VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [
                    projectMember.id,
                    dayjs(projectMember.created).toISOString(),
                    dayjs(projectMember.updated).toISOString(),
                    projectMember.projectId,
